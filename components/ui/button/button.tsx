...
export const Button: FC<TButton> = ({ variant = "primary", ...props }): ReactElement => {
  const className = clsx(
    "font-semibold transition transition-all flex items-center justify-center gap-x-3 duration-300 rounded-lg text-sm px-5 py-2.5 text-center focus:ring-4 focus:outline-none disabled:text-gray-400 disabled:opacity-50 disabled:bg-gray-200 disabled:cursor-not-allowed w-fit",
    {
